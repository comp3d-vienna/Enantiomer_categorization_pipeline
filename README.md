...
## How to use enantiomer_binding_conformation

A computational pipeline of small-molecule enantiomers binding conformation categorization

The project setup is documented in [project_setup.md](project_setup.md). Feel free to remove this document (and/or the link to this document) if you don't need it.

## Installation

To install enantiomer_binding_conformation from GitHub repository, do:
